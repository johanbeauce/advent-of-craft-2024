...
class EncryptionTest {
    ...
    void decrypt_show_the_mail_content() throws Exception {
        ...
        assertThat(decryptedText).isEqualTo(expectedDecryptedText);
    }
